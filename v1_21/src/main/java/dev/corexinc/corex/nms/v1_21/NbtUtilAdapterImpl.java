...
public class NbtUtilAdapterImpl implements NbtUtilAdapter {
    ...
    private AbstractTag toTag(Tag nbt) {
        ...
        return switch (nbt) {
            ...
            case FloatTag value -> new ElementTag(String.valueOf(value.getAsFloat()));
            case DoubleTag value -> new ElementTag(String.valueOf(value.getAsDouble()));
            case NumericTag number -> new ElementTag(String.valueOf(number.getAsLong()));
            case StringTag string -> new ElementTag(string.getAsString());
            default -> new ElementTag(nbt.getAsString());
        };
    }
